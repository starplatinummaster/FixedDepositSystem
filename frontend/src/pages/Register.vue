        ...
        <form @submit.prevent="handleRegister" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                required
                class="w-full px-3 py-3 border border-gray-300 rounded-md placeholder-gray-400 
                       focus:outline-none focus:ring-2 focus:border-gradient focus:ring-gradient pr-10"
              />
              <button
                type="button"
            ...
            <p v-if="password && !isPasswordStrong" class="text-red-500 text-sm mt-1">
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-3 py-3 border border-gray-300 rounded-md placeholder-gray-400 
                     focus:outline-none focus:ring-2 focus:border-gradient focus:ring-gradient"
            />
            <p v-if="email && !isEmailValid" class="text-red-500 text-sm mt-1">Invalid email format</p>
          </div>
          ...
          <div class="text-center">
            <p class="text-sm text-gray-600">
              ...
              <router-link to="/login" class="font-medium text-green-700 hover:text-green-600 underline">
                Sign in
              </router-link>
            </p>
          </div>
...
const handleRegister = async () => {
  ...
  try {
    ...
    if (err.response && err.response.data) {
      ...
      error.value = 'Server not reachable. Please try again.';
    }
  } finally {
    loading.value = false;
  }
